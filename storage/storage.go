...
type StockRepoI interface {
	...
	TransferProduct(ctx context.Context, req *models.MakeATransfer) (int64, error)
}
...
type StaffRepoI interface {
	...
	GetSoldProductsByStaff(ctx context.Context, req *models.SoldDate) (resp []models.StaffBySoldItemsOnDay, err error)
}
...
type OrderRepoI interface {
	...
	AddOrderItemNew(ctx context.Context, req *models.CreateOrderItemNew) (int, error)
	GetTheSum(ctx context.Context, req *models.CountSumRequest) (resp models.CoustSumResponse, err error)
}

type PromoCodeRepoI interface {
	Create(context.Context, models.PromoCode) (int, error)
	GetByID(context.Context, *models.PromoCode) (*models.PromoCode, error)
	GetList(ctx context.Context, req *models.GetListPromoCodetRequest) (resp *models.GetListPromoCodeResponse, err error)
	Update(ctx context.Context, req *models.PromoCode) (int64, error)
	Delete(ctx context.Context, req *models.PromoCode) (int64, error)
}