...
CREATE TABLE orders (
	...
	FOREIGN KEY (store_id) REFERENCES stores (store_id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (promo_code_id) REFERENCES promo_codes (promo_code_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE promo_codes (
	promo_code_id VARCHAR(4) Primary key,
	promo_code_name VARCHAR(255),
	promo_code_type VARCHAR(255),
	promo_code_amount NUMERIC
)
